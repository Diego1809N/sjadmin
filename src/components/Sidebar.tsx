import { LayoutDashboard, FileText, Users, UserCheck, Menu, X, LogOut, TrendingUp, Wrench, FileSignature, CalendarClock } from "lucide-react";
...
const navItems = [
  ...
  { id: "vencimientos", label: "Vencimientos/Actualización", icon: CalendarClock },
];
